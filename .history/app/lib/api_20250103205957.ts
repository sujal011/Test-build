...
export async function saveUserPreferences(userId: string, preferences: any) {
  try {
    ...
    // Instead of throwing, we'll return null to indicate failure
    return null;
  }
}
...
// Function to save preferences locally
export function savePreferencesLocally(preferences: any) {
  localStorage.setItem('userPreferences', JSON.stringify(preferences));
}

// Function to load preferences locally
