...
const RecipeCard = ({ recipe, onClick }: { recipe: Recipe; onClick: () => void }) => {
  return (
    ...
    >
      <Card 
        className="overflow-hidden cursor-pointer hover:shadow-xl transition-shadow bg-white/80 backdrop-blur-md"
        onClick={onClick}
      >
    ...
    <div className="min-h-screen bg-cooking">
      ...
      <div className="min-h-screen bg-black/50 p-8 pt-24">
        <motion.div 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="max-w-4xl mx-auto bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-8"
        >
