  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4">
        <form onSubmit={fetchMealPlan} className="bg-white rounded-lg p-6 shadow-md">
          <h2 className="text-2xl font-semibold mb-4">Personalized Meal Plan</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="mb-4">
              <h3 className="font-medium text-lg mb-2">Diet Preferences</h3>
              <select
