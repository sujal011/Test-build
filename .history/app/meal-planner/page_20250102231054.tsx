  ...
  const fetchRecipes = async () => {
    ...
    try {
      ...
      if (preferences.dietaryTypes.length > 0) {
        params.append('diet', preferences.dietaryTypes.join(','))
      }
      ...
      if (preferences.allergens.length > 0) {
        params.append('excludeIngredients', preferences.allergens.join(','))
      }
                    ...
                    <div className="mb-4">
                      <PieChart width={200} height={200}>
                        <Pie
                          ...
                          outerRadius={60}
                        >
                          {recipe.nutrients && Object.entries(recipe.nutrients).map(([key, value], index) => (
                            <Cell key={`cell-${index}`} fill={['#FF8042', '#00C49F', '#FFBB28'][index]} />
                          ))}
                        </Pie>
                        <Tooltip />
                        <Legend />
